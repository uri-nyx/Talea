...
#define CHARACTERS_PER_ROW    256 /* I like 16 x 8 fontsets. */
#define CHARACTERS_PER_COLUMN 1  /* 128 x 1 is another popular format. */
...
void getFontwh(Uint16 *w, Uint16 *h)
{
	*w = selected_font_w / CHARACTERS_PER_ROW;
	*h = selected_font_h / CHARACTERS_PER_COLUMN;
}
