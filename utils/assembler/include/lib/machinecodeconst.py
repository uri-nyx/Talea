...
class MachineCodeConst:
    ...
    INSTR_LB = 'lb'
    INSTR_LH = 'lh'
    INSTR_LW = 'lhc' # Load halfword from cache
    INSTR_LBU = 'lbu'
    INSTR_LHU = 'lbc' # Load byte from cache (allways unsigned) 
    INSTR_SB = 'sb'
    INSTR_SH = 'sh'
    INSTR_SW = 'shc' # Store halfword to cache
    INSTR_SBC = 'sbc' # Store byte to cache
    INSTR_ADDI = 'addi'
    INSTR_SLTI = 'slti'
    INSTR_SLTIU = 'sltiu'
    INSTR_XORI = 'xori'
    ...
    ALL_INSTR = [INSTR_LUI, INSTR_AUIPC, INSTR_JAL,
                 ...
                 INSTR_SB, INSTR_SH, INSTR_SW, INSTR_SBC, INSTR_ADDI,
    ...
    INSTR_TYPE_S = [INSTR_SW, INSTR_SB, INSTR_SH, INSTR_SBC]
    ...
    INSTR_BOP_LOAD = [INSTR_LW, INSTR_LB,
                      INSTR_LH, INSTR_LBU, INSTR_LHU]
    INSTR_BOP_STORE = [INSTR_SW, INSTR_SB, INSTR_SH, INSTR_SBC]
